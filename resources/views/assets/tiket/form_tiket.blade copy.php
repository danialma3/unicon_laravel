            ...
            <form action="#" method="post">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group first">
                    ...
                    <input type="text" class="form-control" name="tmpt_lahir" placeholder="Banjarbaru...." id="tmpt_lahir">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group first">
              ...
              <div class="d-flex mb-5 mt-4 align-items-center">
                <div class="d-flex align-items-center">
                  <label class="control control--checkbox mb-0"><span class="caption">Klik untuk menyetujui <a href="#">Terms and Conditions</a> dan <a href="#">Privacy Policy</a> Kami.</span>
